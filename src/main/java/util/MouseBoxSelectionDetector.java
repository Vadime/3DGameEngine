...
public class MouseBoxSelectionDetector extends CameraBoxSelectionDetector {
    ...
    public boolean selectGameItem(GameItem[] gameItems, Window window, Vector2d mousePos, ICamera FCamera) {
        ...
        return selectGameItem(gameItems, FCamera.getPosition(), mouseDir);
    }
}
