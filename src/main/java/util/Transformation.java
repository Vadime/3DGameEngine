...
public class Transformation {
    ...
    private static final Matrix4f modelLightViewMatrix = new Matrix4f();
    private static final Matrix4f lightViewMatrix = new Matrix4f();
    private static final Matrix4f ortho2DMatrix = new Matrix4f();
    private static final Matrix4f orthoModelMatrix = new Matrix4f();

    public static Matrix4f getLightViewMatrix() {
        return lightViewMatrix;
    }

    public static void setLightViewMatrix(Matrix4f lightViewMatrix) {
        lightViewMatrix.set(lightViewMatrix);
    }
    ...
    public static Matrix4f buildModelViewMatrix(GameItem gameItem, Matrix4f viewMatrix) {
        return buildModelViewMatrix(buildModelMatrix(gameItem), viewMatrix);
    }
    
    public static Matrix4f buildModelViewMatrix(Matrix4f modelMatrix, Matrix4f viewMatrix) {
        return viewMatrix.mulAffine(modelMatrix, modelViewMatrix);
    }

    public static Matrix4f buildModelLightViewMatrix(GameItem gameItem, Matrix4f lightViewMatrix) {
        return buildModelViewMatrix(buildModelMatrix(gameItem), lightViewMatrix);
    }

    public static Matrix4f buildModelLightViewMatrix(Matrix4f modelMatrix, Matrix4f lightViewMatrix) {
        return lightViewMatrix.mulAffine(modelMatrix, modelLightViewMatrix);
    }

    public static Matrix4f buildOrthoProjModelMatrix(GameItem gameItem, Matrix4f orthoMatrix) {
