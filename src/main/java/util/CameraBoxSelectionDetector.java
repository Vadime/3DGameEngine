...
public class CameraBoxSelectionDetector {
    ...
    public void selectGameItem(GameItem[] gameItems, ICamera FCamera) {
        dir = FCamera.getViewMatrix().positiveZ(dir).negate();
        selectGameItem(gameItems, FCamera.getPosition(), dir);
    }
