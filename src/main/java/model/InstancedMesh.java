...
public class InstancedMesh extends Mesh {
    ...
    public void renderListInstanced(List<GameItem> gameItems, Matrix4f viewMatrix) {
        renderListInstanced(gameItems, false, viewMatrix);
    }

    public void renderListInstanced(List<GameItem> gameItems, boolean billBoard, Matrix4f viewMatrix) {
        initRender();
        ...
        for (int i = 0; i < length; i += chunkSize) {
            ...
            renderChunkInstanced(subList, billBoard, viewMatrix);
        }

        endRender();
    }

    private void renderChunkInstanced(List<GameItem> gameItems, boolean billBoard, Matrix4f viewMatrix) {
